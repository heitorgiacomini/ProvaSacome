...
public class AbpwordpressPermissionDefinitionProvider : PermissionDefinitionProvider
{
    public override void Define(IPermissionDefinitionContext context)
    {
		...
		permissionsContent.AddChild(AbpwordpressPermissions.Content.Create, L("Permissions:Content.Criar"));
		permissionsContent.AddChild(AbpwordpressPermissions.Content.Edit, L("Permissions:Content.Editar"));
		permissionsContent.AddChild(AbpwordpressPermissions.Content.Delete, L("Permissions:Content.Excluir"));
